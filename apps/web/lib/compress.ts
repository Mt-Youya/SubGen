 ...
 */
export async function splitAudio(file: File, onProgress?: (p: CompressProgress) => void): Promise<AudioChunk[]> {
...
export async function compressAudio(file: File, onProgress?: (p: CompressProgress) => void): Promise<File> {
 ...
 */
async function decodeAndResample(file: File, onProgress?: (p: CompressProgress) => void): Promise<AudioBuffer> {
