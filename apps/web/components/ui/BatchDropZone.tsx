...
function acceptFile(f: File): boolean {
  ...
  return ACCEPTED.some((a) => (a.endsWith("/") ? f.type.startsWith(a) : f.name.toLowerCase().endsWith(a)))
}
  ...
  return (
    <>
      ...
      <div
        ...
        onClick={() => {
          if (!disabled) multiRef.current?.click()
        }}
        ...
        {hasFiles ? (
          ...
          <div className="flex flex-col items-center gap-4 py-10 px-6 text-center">
            ...
            <div
              ...
              style={{
                background: dragging ? "var(--color-accent-muted)" : "var(--color-surface-2)",
                border: "1px solid var(--color-border-subtle)",
              }}
            >
              {dragging ? (
            ...
            <div className="space-y-1">
              <p
                ...
                style={{ color: dragging ? "var(--color-accent)" : "var(--color-text-primary)" }}
              >
